...
use crate::{BuildInVoting, VotingExpressionError, VotingMethod, VotingMethodContext, VotingMethodMarker, VotingResult, VotingWithLimit};
use crate::aggregations::Aggregation;
use crate::constants::TMTNumericTypes;
use crate::display::{DisplayTree, IndentWriter};
use crate::parser::traits::VotingExecutable;
use crate::traits::LimitableVotingMethodMarker;
use crate::walk::walk_left_to_right;
use crate::display::impl_display_for_displaytree;
            ...
            B : VotingMethodContext
    {
        match self {
            ...
            VotingOperation::AggregationScope {
                ...
                global_context.set_value(variable_name.clone(), Value::from_as_float(new_result))?;
                Ok(Value::from_as_float(new_result))
            }
