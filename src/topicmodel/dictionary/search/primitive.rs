...
impl SearchOption {
    pub fn new(kind: SearchKind, language: Option<LanguageKind>, threshold: Option<Either<usize, f64>>, ignores_ascii_case: bool) -> Result<Self, SearchOptionError> {
        match kind {
            ...
            NormalizedLevensthein | NormalizedDamerauLevensthein | Jaro | JaroWinkler | SorensenDice => {
                match threshold {
                    None => {
...
impl TryFrom<SearchType> for SearchKind {
...
mod test {
    use either::Either;
    use super::{SearchKind, SearchOption, SearchOptionError, Searcher, SearcherError};
    use crate::topicmodel::dictionary::direction::LanguageKind;
    ...
    use crate::topicmodel::dictionary::search::primitive::SearchOptionError::ThresholdMissing;
    use crate::topicmodel::reference::HashRef;
    ...
    fn can_do_all_searched(){
        ...
        for (kind, lang, thresh, ascii, dict, inp, expected) in [
            ...
            (SearchKind::Hamming, None, Some(Either::Left(3)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::Hamming, Some(A), Some(Either::Left(3)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::Hamming, Some(B), Some(Either::Left(3)), false, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::Hamming, None, Some(Either::Left(3)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::Hamming, Some(A), Some(Either::Left(3)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::Hamming, Some(B), Some(Either::Left(3)), true, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::Hamming, None, None, false, &dict, "Hallo".to_string().into(), Err(ThresholdMissing {expected: "usize", kind: SearchKind::Hamming})),

            (SearchKind::Levensthein, None, Some(Either::Left(1)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::Levensthein, Some(A), Some(Either::Left(1)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::Levensthein, Some(B), Some(Either::Left(1)), false, &dict, "Hallo".to_string().into(), cr::<_, &str>([])),
            (SearchKind::Levensthein, None, Some(Either::Left(1)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::Levensthein, Some(A), Some(Either::Left(1)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::Levensthein, Some(B), Some(Either::Left(1)), true, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::Levensthein, None, None, false, &dict, "Hallo".to_string().into(), Err(ThresholdMissing {expected: "usize", kind: SearchKind::Levensthein})),

            (SearchKind::OsaDistance, None, Some(Either::Left(3)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::OsaDistance, Some(A), Some(Either::Left(3)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::OsaDistance, Some(B), Some(Either::Left(3)), false, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::OsaDistance, None, Some(Either::Left(3)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::OsaDistance, Some(A), Some(Either::Left(3)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::OsaDistance, Some(B), Some(Either::Left(3)), true, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::OsaDistance, None, None, false, &dict, "Hallo".to_string().into(), Err(ThresholdMissing {expected: "usize", kind: SearchKind::OsaDistance})),

            (SearchKind::NormalizedLevensthein, None, Some(Either::Right(0.6)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::NormalizedLevensthein, Some(A), Some(Either::Right(0.7)), false, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::NormalizedLevensthein, Some(B), Some(Either::Right(0.6)), false, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::NormalizedLevensthein, None, Some(Either::Right(0.7)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo"), (B, 0, "hello")])),
            (SearchKind::NormalizedLevensthein, Some(A), Some(Either::Right(0.7)), true, &dict, "Hallo".to_string().into(), cr([(A, 0, "hallo"), (A, 1, "Hallo")])),
            (SearchKind::NormalizedLevensthein, Some(B), Some(Either::Right(0.7)), true, &dict, "Hallo".to_string().into(), cr::<_, &str>([(B, 0, "hello")])),
            (SearchKind::NormalizedLevensthein, None, None, false, &dict, "Hallo".to_string().into(), Err(ThresholdMissing {expected: "f64", kind: SearchKind::NormalizedLevensthein})),
        ] {
