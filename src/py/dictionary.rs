...
mod test  {
    ...
    use crate::py::tokenizer::PyAlignedArticleProcessor;
    use crate::topicmodel::dictionary::{DictionaryFilterable, DictionaryWithVocabulary};
    ...
    #[test]
    fn see(){
        let dict = PyDictionary::load(r#"E:\git\tmt\test\dictionary_final2.dat.zst"#.into()).unwrap();
        let ct = dict.get().metadata.domain_count();
        println!("{}", ct.0);
        println!("==================");
        println!("{}", ct.1);
    }
    ...
    fn test_processing(){
        let dict = {
            ...
            let mut dict = PyDictionary::load(r#"E:\git\tmt\test\dictionary_final3.dat.zst"#.into()).unwrap();

            dict.create_html_view_in(
                r#"E:\tmp\tmt_experiments\views\dictionary_final3"#.into(), None, None
            ).unwrap();
            ...
            dict.get().write_to_path_with_extension(r#"E:\git\tmt\test\dictionary_final3_proc1.dat.zst"#).unwrap();

            dict.get().generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final3_proc1"#, false
            ).unwrap();
        ...
        let dict = {
            ...
            dict.get().write_to_path_with_extension(r#"E:\git\tmt\test\dictionary_final3_proc2.dat.zst"#).unwrap();
            dict.get().generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final3_proc2"#, false
            ).unwrap();
            dict
        };
        ...
        let dict = {
            ...
            dict.write_to_path_with_extension(r#"E:\git\tmt\test\dictionary_final3_proc3.dat.zst"#).unwrap();
            dict.generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final3_proc3"#, false
            ).unwrap();
            dict
        };
        ...
        let dict = {
            ...
            dict.write_to_path_with_extension(r#"E:\git\tmt\test\dictionary_final3_proc4.dat.zst"#).unwrap();
            dict.generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final3_proc4"#, false
            ).unwrap();
            dict
        };
