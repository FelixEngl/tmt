...
mod test  {
    ...
    fn test_processing(){
        let dict = {
            ...
            let mut dict = PyDictionary::load(r#"E:\git\tmt\test\dictionary_final4.dat.zst"#.into()).unwrap();

            dict.create_html_view_in(
                r#"E:\tmp\tmt_experiments\views\dictionary_final4"#.into(), None, None
            ).unwrap();
            ...
            dict.get().generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final4_proc1"#, false
            ).unwrap();
        ...
        let dict = {
            ...
            dict.get().write_to_path_with_extension(r#"E:\git\tmt\test\dictionary_final4_proc2.dat.zst"#).unwrap();
            dict.get().generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final4_proc2"#, false
            ).unwrap();
            dict
        };
        ...
        let dict = {
            ...
            dict.generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final4_proc3"#, false
            ).unwrap();
            dict
        };
        ...
        let dict = {
            ...
            dict.write_to_path_with_extension(r#"E:\git\tmt\test\dictionary_final4_proc4.dat.zst"#).unwrap();
            dict.generate_html(
                r#"E:\tmp\tmt_experiments\views\dictionary_final4_proc4"#, false
            ).unwrap();
            dict
        };
