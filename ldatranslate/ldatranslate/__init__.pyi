...
class PyHorizontalBoostConfig:
    def __new__(cls,divergence,mean_method = ...,normalize_mode = ...,alpha = ...,linear_transformed = ...,booster = ...,factor = ...,only_positive_boost = ...): ...
    ...
...
class PyNGramLanguageBoostConfig:
...
class PyVerticalBoostConfig:
    def __new__(cls,divergence,norm = ...,factor = ...,only_positive_boost = ...): ...
    ...
