...
use ldatranslate_topicmodel::model::{DocumentLength, DocumentTo, FullTopicModel, Probability, TopicModel, TopicTo, WordFrequency, WordTo};
...
mod test {
    ...
    use ldatranslate_topicmodel::model::DisplayableTopicModel;
