...
def read_and_parse_aligned_articles_into(path_in: Path | PathLike | str, with_pickle: bool, path_out: Path | PathLike | str, processor: PyAlignedArticleProcessor, temp_folder: Path | PathLike | str | None = None) -> int:
    """
