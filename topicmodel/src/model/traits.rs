...
pub trait TopicModelWithVocabulary<T, Voc>: BasicTopicModelWithVocabulary<T, Voc> where Voc: BasicVocabulary<T> {
    ...
    #[inline]
    fn get_word_metas_with_word_by_word<'a, 'b, Q: ?Sized>(&'a self, word: &'b Q) -> Option<TopicTo<WordMetaWithWord<'a, T, <Self as BasicTopicModel>::WordMeta<'a>>>> where T: Borrow<Q>, Q: Hash + Eq, Voc: 'a {
