...
use crate::dictionary::loader::helper::take_nested_bracket_delimited;
use crate::dictionary::loader::word_infos::{PartialWordType};
...
pub mod entry_processing {
    use crate::dictionary::loader::ding;
    use crate::dictionary::loader::ding::{Abbreviation, DingAlternatingWord, DingAlternatingWordValue, DingWordEntry, DingWordEntryElement, WordInfo};
    use crate::dictionary::metadata::ex::{MetadataCollection, MetadataCollectionBuilder};
