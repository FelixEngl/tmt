...
use thiserror::Error;
use crate::dictionary::metadata::ex::MetadataCollectionBuilder;
use crate::dictionary::word_infos::{AnyWordInfo, Domain, Language, PartOfSpeech, PartOfSpeechTag, Register};
...
mod test {
    ...
    use rayon::prelude::*;
    use ldatranslate_toolkit::define_aho_matcher;
    use crate::dictionary::loader::wiktionary_reader::{read_wiktionary, WiktionaryReaderError};
    use crate::dictionary::word_infos::{Domain, AnyWordInfo};
