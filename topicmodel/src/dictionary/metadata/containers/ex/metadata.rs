...
macro_rules! implement_update {
    ($targ: ident, $update: ident, $L: ident => voc: $name: ident, $($tt:tt)*) => {
        ...
        $crate::dictionary::metadata::ex::metadata::implement_update!($targ, $update, $L => $($tt)*);
    };
...
macro_rules! implement_id_collection {
    ($targ: ident, $collector: ident => voc: $name: ident, $($tt:tt)*) => {
        ...
        $crate::dictionary::metadata::ex::metadata::implement_id_collection!($targ, $collector => $($tt)*);
    };
...
macro_rules! impl_associated_metadata {
    ...
    ($($tt: tt: $($doc: literal)? $name: ident: $typ: ty),+ $(,)?) => {
        ...
        paste::paste! {
            $crate::dictionary::metadata::ex::metadata::impl_general_metadata!(
                $($name, [<$name:camel>], $typ;)+
            );
            $crate::dictionary::metadata::ex::metadata::impl_keys!(
                $($name, [<$name:camel>], $typ;)+
            );
        }
        ...
        impl AssociatedMetadata {
            ...
            #[inline(always)]
            pub fn $name(&self) -> Option<&$crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ>> {
                self.inner.get()?.$name()
            }
            ...
            paste::paste! {
                /// Get the values of the field
                #[inline(always)]
                pub fn [<$name _mut>](&mut self) -> Option<&mut $crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ>> {
                    self.inner.get_mut()?.[<$name _mut>]()
                }

                /// Get the values of the field
                #[inline(always)]
                pub fn [<get_or_init_ $name>](&mut self) -> &mut $crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ> {
            ...
            #[inline(always)]
            pub fn add_single_generic(&mut self, value: $crate::dictionary::metadata::containers::ex::GenericMetadataValue) {
        ...
        impl AssociatedMetadataImpl {
            ...
            $(
            pub fn $name(&self) -> Option<&$crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ>> {
                use $crate::dictionary::metadata::containers::ex::MetaField;
                Some(
                    unsafe {
                        paste::paste! {
            ...
            pub fn add_single_generic(&mut self, value: $crate::dictionary::metadata::containers::ex::GenericMetadataValue) {
                use $crate::dictionary::metadata::containers::ex::GenericMetadataValue;
                paste::paste! {
                    match value {
            ...
            pub fn update_ids<L: $crate::dictionary::direction::Language>(
                &mut self,
                update: &$crate::dictionary::metadata::update::WordIdUpdate
            ) {
                $crate::dictionary::metadata::ex::metadata::implement_update!(
            ...
            pub fn collect_all_known_ids(&self) -> tinyset::Set64<usize> {
                ...
                $crate::dictionary::metadata::ex::metadata::implement_id_collection!(
...
macro_rules! impl_keys {
    (
        ...
        impl GenericMetadataValue {
            ...
            pub fn associated_key(&self) -> $crate::dictionary::metadata::containers::ex::MetaField {
                match self {
                    $(
                    Self::$enum_var_name(_) => $crate::dictionary::metadata::containers::ex::MetaField::$enum_var_name,
                    )+
                }
            }
        }
        ...
        pub enum MetadataContainerValue {
            $($enum_var_name($crate::dictionary::metadata::containers::ex::metadata::MetadataContainerValueGeneric<$typ>),
            )+
        }
        ...
        impl MetadataContainerValue {
            ...
            pub fn create_for_key(key: $crate::dictionary::metadata::containers::ex::MetaField) -> Self {
                use $crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric;
                use $crate::dictionary::metadata::containers::ex::MetaField;
                match key {
                    $(
            ...
            pub fn update(&mut self, other: &$crate::dictionary::metadata::containers::ex::MetadataContainerValue, add_only_associated_count: bool) {
                use $crate::dictionary::metadata::containers::ex::MetadataContainerValue;
                match (self, other) {
                    $(
            ...
            paste::paste! {
                $(
                pub fn [<as_ref_ $normal_name>](&self) -> Option<&$crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ>> {
                    match self {
                ...
                pub fn [<as_mut_ $normal_name>](&mut self) -> Option<&mut $crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ>> {
                    match self {
                        Self::$enum_var_name(resolved_value) => {
                            Some(resolved_value)
                        }
                ...
                pub unsafe fn [<as_ref_unchecked_ $normal_name>](&self) -> &$crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ> {
                    match self {
                        Self::$enum_var_name(resolved_value) => {
                            resolved_value
                        }
                ...
                pub unsafe fn [<as_mut_unchecked_ $normal_name>](&mut self) -> &mut $crate::dictionary::metadata::containers::ex::MetadataContainerValueGeneric<$typ> {
                    match self {
                        Self::$enum_var_name(resolved_value) => {
                            resolved_value
                        }
...
macro_rules! create_metadata_impl {
    ($($tt:tt)+) => {
        $crate::dictionary::metadata::ex::metadata::impl_associated_metadata!($($tt)+);
    };
}
...
impl crate::dictionary::metadata::Metadata for MetadataEx{}
...
mod test {
    ...
    use crate::dictionary::metadata::ex::{AssociatedMetadataImpl, MetadataEx};
    use crate::dictionary::word_infos::PartOfSpeech;
    use crate::interners::AnyIdSymbol;
