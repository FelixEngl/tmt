...
use crate::dictionary::metadata::MetadataManagerGen;
use crate::dictionary::metadata::update::WordIdUpdate;
use crate::vocabulary::{AnonymousVocabularyMut, AnonymousVocabularyRef, Vocabulary};
use crate::vocabulary::phantom::{anonymous_mut_voc, anonymous_voc};

/// Contains the metadata for the dictionary
#[derive(Serialize, Deserialize, Debug, Eq, PartialEq)]
pub struct ClassicMetadataManager {
    pub(in crate::dictionary) meta_a: Vec<ClassicMetadata>,
    pub(in crate::dictionary) meta_b: Vec<ClassicMetadata>,
    pub(in crate::dictionary) dictionary_interner: DictionaryOriginStringInterner,
    #[serde(alias = "tag_interner")]
    pub(in crate::dictionary) subject_interner: TagStringInterner,
    pub(in crate::dictionary) unstemmed_voc: Vocabulary<String>,
}
...
mod test {
    ...
    use crate::dictionary::metadata::classic::python::SolvedMetadata;
    use crate::dictionary::metadata::{MetadataManagerGen};
    use crate::vocabulary::phantom::{anonymous_voc};
