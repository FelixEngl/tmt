...
use crate::dictionary::metadata::{DictionaryWithMetaIter, MetaIter, MetaMutIter, MetadataMutReference};
use crate::dictionary::search::DictionarySearcher;
use crate::language_hint::LanguageHint;
use crate::vocabulary::{AnonymousVocabulary, AnonymousVocabularyMut, BasicVocabulary, SearchableVocabulary, VocabularyMut};
...
pub trait SearchableDictionaryWithMetadata<T, V, M>: DictionaryWithVocabulary<T, V> + BasicDictionaryWithMeta<M, V>
where
    M: MetadataManager,
...
impl<T, V, M, D> SearchableDictionaryWithMetadata<T, V, M> for D
where
    D: DictionaryWithVocabulary<T, V> + BasicDictionaryWithMeta<M, V>,
    M: MetadataManager,
    V: AnonymousVocabulary + BasicVocabulary<T>
{}
