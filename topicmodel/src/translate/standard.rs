...
//     T: Sync + Send
// {
//     type VoterMeta<'a> = &'a StandardVoterMeta where Self: 'a;
//
...
//     type TopicMetas<'a> = &'a [StandardTopicMeta] where Self: 'a;
//
//     fn len(&self) -> usize {
...
//     }
//
//     fn matrix<'a>(&self) -> Self::TopicToVoterMatrix<'a> {
//         &self.topic_to_voters
//     }
//
//     fn matrix_meta<'a>(&self) -> Self::TopicMetas<'a> {
//         &self.topic_meta
//     }
// }
//
